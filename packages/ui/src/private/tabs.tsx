...
function Tabs({
  ...
  ...props
}: PublicProps<TabsPrimitive.Root.Props>) {
  return (
    <TabsPrimitive.Root
...
function TabsList({
  variant = "default",
  ...props
}: PublicProps<TabsPrimitive.List.Props> &
...
function TabsTrigger({ ...props }: PublicProps<TabsPrimitive.Tab.Props>) {
  return (
    <TabsPrimitive.Tab
...
function TabsContent({ ...props }: PublicProps<TabsPrimitive.Panel.Props>) {
  return (
    <TabsPrimitive.Panel
      data-slot="tabs-content"
      className="flex-1 text-xs/relaxed outline-none"
      {...props}
    />
  )
}
