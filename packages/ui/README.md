...
| Cards      | compact/comfortable/spacious density; default/metric/record structure; title, description, summary, details, body, footer                             |
| Tables     | column label/alignment/sortability; compact/comfortable density; raw sort values; row activation by ID; none/single/multiple selection; empty message |
...
| Charts     | primary/secondary series tones; point labels and numeric values                                                                                       |
...
| ./components/card              | Card             | `children`, `density`, `title`, `description`, `summary`, `footer`, `details`, `variant`, `data-testid`                                                                                                                                                 |
| ./components/data-table        | DataTable        | `ariaLabel`, `columns`, `rows`, `density`, `emptyMessage`, `onRowActivate`, `sorting`, `defaultSorting`, `onSortingChange`, `selection`, `selectedIds`, `defaultSelectedIds`, `activeRowId`, `onSelectionChange`, `data-testid`                                        |
...
| ./components/drawer            | Drawer           | `children`, `title`, `description`, `open`, `defaultOpen`, `onOpenChange`, `trigger`, `actions`, `placement`, `density`, `headerVisibility`, `initialFocus`, `data-testid`                                                                              |
...
| ./components/line-chart        | LineChart        | `ariaLabel`, `tone`, `data`, `height`                                                                                                                                                                                                                   |
...
Public supporting types: `ButtonProps`, `BadgeVariant`, `BadgeProps`, `CardDetail`, `CardProps`, `TableCellValue`, `TableColumn`, `TableRowData`, `TableSort`, `DataTableProps`, `DateRange`, `DateRangePickerProps`, `OverlayAction`, `OverlayTrigger`, `DrawerProps`, `FormFieldProps`, `FocusHandle`, `InputProps`, `KbdProps`, `LineChartPoint`, `LineChartProps`, `SingleCalendarProps`, `RangeCalendarProps`, `CalendarProps`, `PopoverProps`, `SelectOption`, `SelectProps`, `TabItem`, `TabsProps`, `TextProps`, `NavigationItemProps`.
