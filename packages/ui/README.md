...
| ./components/data-table        | DataTable        | `ariaLabel`, `columns`, `rows`, `density`, `emptyMessage`, `onRowActivate`, `sorting`, `defaultSorting`, `onSortingChange`, `selection`, `selectedIds`, `defaultSelectedIds`, `onSelectionChange`, `data-testid`                                        |
...
| ./components/line-chart        | LineChart        | `ariaLabel`, `tone`, `data`                                                                                                                                                                                                                             |
